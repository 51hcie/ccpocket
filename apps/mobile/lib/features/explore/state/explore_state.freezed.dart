...
class _ExploreState implements ExploreState {
  const _ExploreState({required this.projectPath, this.currentPath = '',  List<String> allFiles = const [],  List<ExploreEntry> visibleEntries = const [], this.status = ExploreStatus.loading, this.fileListTruncated = false, this.totalFiles, this.error}): _allFiles = allFiles,_visibleEntries = visibleEntries;
