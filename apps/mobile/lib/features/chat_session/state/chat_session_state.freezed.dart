...
switch (_that) {
case _ChatSessionState() when $default != null:
return $default(_that.status,_that.entries,_that.approval,_that.claudeSessionId,_that.projectPath,_that.gitBranch,_that.explorerCurrentPath,_that.recentPeekedFiles,_that.pastHistoryLoaded,_that.bulkLoading,_that.inPlanMode,_that.collapseToolResults,_that.sessionUnavailable,_that.permissionMode,_that.executionMode,_that.codexApprovalPolicy,_that.codexApprovalsReviewer,_that.codexPermissionsMode,_that.codexModel,_that.codexModelReasoningEffort,_that.codexSpeed,_that.planMode,_that.sandboxMode,_that.hiddenToolUseIds,_that.rewindPreview,_that.totalCost,_that.totalDuration,_that.slashCommands,_that.queuedInput,_that.goal);case _:
  return orElse();
